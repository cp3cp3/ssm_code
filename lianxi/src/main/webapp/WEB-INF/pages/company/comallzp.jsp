		...
		<div id="sort">
			<table width="100%" border="0" cellspacing="0">
				<tr>
					...
					<td>
						<div class="sort_sort">
							<div class="sort_b"><a href="#" onclick="return false;"><div class="sort_b_inner"><i class="cate_sort"></i><span>网站相关</span><div class="clear"></div></div></a></div>
						</div>
					</td>
					<td class="sort_right">
						<div class="sort_tag">
		...
		<div id="content">	
			<div id="list">
				...
				<ul>
					...
					<div>					
						<div class="wrap">
							<a class="alist" href="<%=request.getContextPath() %>/main.do?pageNow=1" onClick="return confirm('您还没有登录，此投递简历权限只限于普通用户');">
								<div class="list_litpic fl"><img src="<%=request.getContextPath() %>/images/142013403687.gif" /></div>
								<div class="list_info">
									<h4>${r.recname } | <span>${r.extent }K</span></h4>
			...
			<tr>
				...
				<c:if test="${page.pageNow>1}"> 
					<a style="color:blue" onMouseOver = "this.style.color = 'red'"  href="<%=request.getContextPath() %>/page/pageall.do?pageNow=1">首页</a>
					
					</c:if>
				<c:if test="${page.pageNow-1>0}">
				 <a style="color:blue" onMouseOver = "this.style.color = 'red'"  href="<%=request.getContextPath() %>/page/pageall.do?pageNow=${page.pageNow-1}">上一页</a>
				  </c:if>
					
					<c:if test="${page.pageNow<page.totalPageCount}">
					
					 <a style="color:blue" onMouseOver = "this.style.color = 'red'"  href="<%=request.getContextPath() %>/page/pageall.do?pageNow=${page.pageNow+1}">下一页</a>
					
					<a style="color:blue" onMouseOver = "this.style.color = 'red'"  href="<%=request.getContextPath() %>/page/pageall.do?pageNow=${page.totalPageCount}">尾页</a>
					</c:if>
				</font>
